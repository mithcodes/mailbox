...
function Main() {
  ...
  const handleInbox = () => {
    ...
    dispatch(uiSliceActions.allMail())
  };
  ...
  const readMail=()=>{
    dispatch(uiSliceActions.readMail())
  }

  const unreadMail=()=>{
    dispatch(uiSliceActions.unreadMail())
  }
          ...
          <Row>
            ...
            >
              ...
              <nav className="nav flex-column">
                ...
                <a className="nav-link" href="#contact" onClick={unreadMail}>
                  Unread
                </a>
                <a className="nav-link" href="#contact" onClick={readMail}>
                  Read
                </a>
              </nav>
            </Col>
